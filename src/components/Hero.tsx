...
export default function Hero() {
    ...
    <div className="relative isolate px-6 lg:px-8">
      <div
        ...
        <div className="mx-auto max-w-2xl overflow-hidden pt-12 sm:pt-28 lg:pt-36  mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 px-5">
          <div className="text-left animate-fade-right animate-ease-linear">
            ...
            <div className="mt-10 flex items-center gap-x-6">
              <a
                ...
                className={`rounded-md px-3.5 py-2.5 text-sm font-semibold text-white ${style.hire}`}
              >
                Hire Me
              </a>
              <a href="#Projects" className={`text-sm font-semibold leading-6 text-gray-900 ${style.projects}`}>
