...
export default function Hero() {
    ...
    <div className="relative isolate px-2 lg:px-8 ">
        <div className=" text-left mx-auto max-w-2xl overflow-hidden pt-28 sm:pt-28 lg:pt-36  mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 px-5">
